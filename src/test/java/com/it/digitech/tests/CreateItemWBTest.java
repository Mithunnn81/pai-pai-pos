...
import com.it.digitech.pages.CreateItemWBPage;
import com.it.digitech.utilities.CommonMethods;
import com.it.digitech.utilities.ExtentFactory;

public class CreateItemWBTest extends CommonMethods{
	...
	@Test
	public void CreateItemWBMethod() throws IOException {
		
		childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>Check for a successful Item creation</b></p>");
		CreateItemWBPage createItemWBPage = new CreateItemWBPage(childTest);
		createItemWBPage.CreateItemWB();
