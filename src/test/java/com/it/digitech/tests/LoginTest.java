...
import com.it.digitech.pages.LoginPage;
...
public class LoginTest extends CommonMethods{
	...
	public void openUrl() throws InterruptedException {
		...
		parentTest = report.createTest("<p style=\"color:#FF6000; font-size:20px\"><b>Login</b></p>").assignAuthor("Mithun").assignDevice("Windows");
	}
